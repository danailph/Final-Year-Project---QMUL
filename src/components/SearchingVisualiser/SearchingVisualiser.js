...
const SearchingVisualiser = forwardRef((props, ref) => {
    ...
    return <div className="searching-visualiser-container">
        <div className="searching-visualiser-inner-container">
            <div className="searching-visualiser-container">
                <div className="searching-visualiser-header">

                    <h2>{optionLabel}</h2>
                </div>

                <div className="searching-visualiser-content" ref={graphRef}>
                    {graph.map(([node]) =>
                        <div
                            key={`node-${node}`}
                            id={`node-${node}`}
